...
> - Would love to see more textures and original parts that could be set as variants. Would need help. :D
...
- [x]  [Community Tech Tree (CTT)][thread:ctt]
...
- none (all part have been renamed to not cause conflicts)
...
![MoarKerbals Screenshots][IMG:hero:1] 

[Javascript is disabled. View full album][IMGUR:0]
...
[thread:MOAR]: https://forum.kerbalspaceprogram.com/index.php?/topic/191525-* "MoarKerbals (MOAR)"
